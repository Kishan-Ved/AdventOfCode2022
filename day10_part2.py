...
while True:
    ...
    if inp=="q": # Used to take input, copy and paste it in the console. Type q in the next line to start the execution of the program
        break
    if inp=="noop":
        if c%40==x or c%40==x+1 or c%40==x-1:
            s = s + "#"
        else:
            s = s + "."
        c+=1
...
# d1 = {0:[97, 81, 57, 57, 91, 61],1:[88, 62, 68, 90],2:[74, 87],3:[53, 81, 60, 87, 90, 99, 75],4:[57],5:[54, 84, 91, 55, 59, 72, 75, 70],6:[95, 79, 79, 68, 78],7:[61, 97, 67]}
# l = [0,0,0,0,0,0,0,0]
# for i in range(500):
